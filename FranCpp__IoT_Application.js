...
function process_ButtonSensor_Notification(req, res) {
    ...
    if  (!vrq) {
        ...
        createContentInstance("ESPActuator","[Button]");
        // Faire quelque chose avec Hall2SensorValue
        // ...
        // ...
        // ...
        // Si vous voulez commander un actionneur :
        //      createContentInstance("RedLed1Actuator", "[switchOn]");
        //          ou
        //      createContentInstance("RedLed1Actuator", "[switchOff]");
    }
...
function process_Hall1Sensor_Notification(req, res) {
    ...
    if  (!vrq) {
        ...
        createContentInstance("ESPActuator","[H1]");
        // Faire quelque chose avec Hall2SensorValue
        // ...
        // ...
        // ...
...
function process_Hall2Sensor_Notification(req, res) {
    ...
    if  (!vrq) {
        ...
        createContentInstance("ESPActuator","[H2]");
        // Faire quelque chose avec Hall2SensorValue
        // ...
        // ...
        // ...
